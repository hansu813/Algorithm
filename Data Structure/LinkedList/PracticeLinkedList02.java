...
class DublyLinkedList extends LinkedListExample {
	NodeBi head;
	NodeBi tail;
	
	public DublyLinkedList(NodeBi node) {
		this.head = node;
		this.tail = node;
	}
...
public class PracticeLinkedList02 {

	
	public static void main(String[] args) {
//		Test Code
		DublyLinkedList myList = new DublyLinkedList(new NodeBi(1, null, null));
		myList.showData();
